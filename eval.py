...
def parse_args():
	...
	parser.add_argument('--draw_boxes', type=bool, default=False)
...
def main():
	...
	if args.draw_boxes and len(images) > 100:
	...
	for num, image in enumerate(images):
		if args.draw_boxes:
			...
			Image.fromarray(results['image']).save('./predictions_test/' + str(num) + '.jpg')
